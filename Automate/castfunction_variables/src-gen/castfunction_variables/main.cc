...
int main(int argc, char **argv) {
  cxxopts::Options options("castfunction_variables", "Reactor Program");
  ...
  auto main = std ::make_unique<castfunction_variables> ("castfunction_variables", &e, castfunction_variables::Parameters{});
