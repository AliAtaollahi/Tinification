...
#cd rebecfiles/src
java -jar rmc-2.14.jar -s "$1" -p "$3"  -o output_folder -v 2.1 -e TIMED_REBECA -x -f  >/dev/null 2>&1
...
temp_file="temp1.txt"
mv statespace.xml example.statespace
# Write the argument passed to the temp file
echo -e "example.statespace" > "temp1.txt" 
...
dot -Tpng new.dot -o "$1_without_shift.png"
echo "png generated"    
fi
