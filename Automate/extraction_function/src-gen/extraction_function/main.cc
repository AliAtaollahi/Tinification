...
int main(int argc, char **argv) {
  cxxopts::Options options("extraction_function", "Reactor Program");
  ...
  auto main = std ::make_unique<extraction_function> ("extraction_function", &e, extraction_function::Parameters{});
